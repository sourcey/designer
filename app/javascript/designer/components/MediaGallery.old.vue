  ...
  <div class="image-uploader">
        ...
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr v-for="(file, index) in files" :key="file.id">
              ...
              <!--
              <td v-if="file.speed">{{file.speed | humanSize}}</td>
              <td v-else></td>
              -->
    ...
    <div class="option" v-show="showOptions">
      ...
      <div class="form-group">
        ...
        <small class="form-text text-muted" v-if="autoCompress > 0">More than {{autoCompress | humanSize}} files are automatically compressed</small>
...
export default {
  ...
  data() {
    return {
      ...
      thread: 3,
      name: 'file',
      postAction: this.attachment_upload_path, //'/upload/post',
      putAction: null, //this.attachment_upload_path, //'/upload/put',
      headers: {
        'X-Csrf-Token': 'xxxx',
      },
      data: {
  ...
  created() {
    let self = this
    $.ajax({
      url: this.attachment_upload_path,
      dataType: 'json'
